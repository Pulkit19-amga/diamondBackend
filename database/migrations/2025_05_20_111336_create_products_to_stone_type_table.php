...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('products_to_stone_type', function (Blueprint $table) {
            ...
            $table->unsignedInteger('sptst_products_id')->nullable();
            $table->unsignedInteger('sptst_stone_type_id')->nullable();
            ...
            $table->foreign('sptst_stone_type_id')->references('pst_id')->on('products_stone_type')->nullOnDelete();
        });
    }
